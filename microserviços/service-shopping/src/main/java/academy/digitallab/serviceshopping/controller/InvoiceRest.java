package academy.digitallab.serviceshopping.controller;

import academy.digitallab.serviceshopping.entity.Invoice;
import academy.digitallab.serviceshopping.service.InvoiceService;
...
public class InvoiceRest {
    ...
    public ResponseEntity<Invoice> getInvoice(@PathVariable("id") long id) {
        log.info("Fetching Invoice with id {}", id); // Implementa um log de error
